...
import org.lba.springboot2.kafka.model.json.Account;
...
public class KafkaControllerJSON {
    ...
    Logger logger = LoggerFactory.getLogger(KafkaControllerJSON.class);

    public KafkaControllerJSON(KafkaTemplate kafkaTemplate) {
